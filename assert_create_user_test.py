...
# Тест 2. Успешное создание пользователя (15 символов)
def test_create_user_15_letter_in_first_name_get_success_response():
    positive_assert("Ааааааааааааааа")
    
# Функция для негативной проверки (некорректные данные)    
...
# Тест 3. Количество символов меньше допустимого (1 символ)
def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("A")

# Тест 4. Количество символов больше допустимого (16 символов)
...
# Функция для негативной проверки (не переданы данные)    
